        ...
        <div className='grid grid-cols-3 items-center text-center py-5'>
            ...
            <div className='menu-button flex gap-3 justify-center text-sm'>
                ...
                <button
                    ...
                    className={`menu-button px-2 py-1 cursor-pointer lg:px-3 lg:py-2 ${page === PAGES.PRODUCTS ? "active" : ""}`}>Products
                </button>
                {/* cart page button */}
                <button
                    onClick={() => setPage(PAGES.CART)}
                    className={`menu-button px-2 py-1 cursor-pointer lg:px-3 lg:py-2 ${page === PAGES.CART ? "active" : ""}`}>Cart
                </button>
            </div>
            ...
            <div onClick={() => setPage(PAGES.CART)}
                ...
                <span className='text-xl transition hover:text-[#E8FF47] active:text-[#E8FF47]'>Cart</span>
